...
class App:
    def __init__(self):
        ...
        self.font = pygame.font.Font('assets/pico-8.ttf', 12)
    ...
    def end(self):
        ...
        if self.win:
            self.screen.blit(self.win_render, (self.width//2-self.win_render.get_width()//2, self.height//2-self.win_render.get_height()//2))
        else:
            self.screen.blit(self.lose_render, (self.width//2-self.win_render.get_width()//2, self.height//2-self.win_render.get_height()//2))
        pygame.display.flip()
